const { verificationLevel, systemChannelFlags, defaultMessageNotificationLevel } = require('../Constants');
...
module.exports = class Guild {
    constructor(data) {
        ...
        this.afk_timeout                 = data.afk_timeout || 300;
        this.premiumSubscriptionCount    = data.premium_subscription_count || 0;
        this.nsfw                        = data.nsfw;
        this.mfaRequirement              = !!data.mfa_level;
        this.name                        = data.name;
        this.joinedAt                    = new Date(data.joined_at);
        this.systemChannelFlags          = data.system_channel_flags ? Object.entries(parseFlags(data.system_channel_flags, systemChannelFlags)).filter(x => x[1])[0][0] : null;
